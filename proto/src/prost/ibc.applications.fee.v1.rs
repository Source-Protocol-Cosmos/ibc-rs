...
pub mod msg_client {
    ...
    use tonic::codegen::*;
    #[doc = " Msg defines the ICS29 Msg service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " RegisterCounterpartyAddress defines a rpc handler method for MsgRegisterCounterpartyAddress"]
        #[doc = " RegisterCounterpartyAddress is called by the relayer on each channelEnd and allows them to specify their"]
        #[doc = " counterparty address before relaying. This ensures they will be properly compensated for forward relaying since"]
        #[doc = " destination chain must send back relayer's source address (counterparty address) in acknowledgement. This function"]
        #[doc = " may be called more than once by a relayer, in which case, latest counterparty address is always used."]
        pub async fn register_counterparty_address(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgRegisterCounterpartyAddress>,
        ) -> Result<tonic::Response<super::MsgRegisterCounterpartyAddressResponse>, tonic::Status>
        {
        ...
        #[doc = " PayPacketFee defines a rpc handler method for MsgPayPacketFee"]
        #[doc = " PayPacketFee is an open callback that may be called by any module/user that wishes to escrow funds in order to"]
        #[doc = " incentivize the relaying of the packet at the next sequence"]
        #[doc = " NOTE: This method is intended to be used within a multi msg transaction, where the subsequent msg that follows"]
        #[doc = " initiates the lifecycle of the incentivized packet"]
        ...
        #[doc = " PayPacketFeeAsync defines a rpc handler method for MsgPayPacketFeeAsync"]
        #[doc = " PayPacketFeeAsync is an open callback that may be called by any module/user that wishes to escrow funds in order to"]
        #[doc = " incentivize the relaying of a known packet (i.e. at a particular sequence)"]
...
pub mod query_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Query defines the ICS29 gRPC querier service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " IncentivizedPackets returns all incentivized packets and their associated fees"]
        ...
        #[doc = " IncentivizedPacket returns all packet fees for a packet given its identifier"]
        ...
        #[doc = " Gets all incentivized packets for a specific channel"]
        ...
        #[doc = " TotalRecvFees returns the total receive fees for a packet given its identifier"]
        ...
        #[doc = " TotalAckFees returns the total acknowledgement fees for a packet given its identifier"]
        ...
        #[doc = " TotalTimeoutFees returns the total timeout fees for a packet given its identifier"]
        ...
        #[doc = " CounterpartyAddress returns the registered counterparty address for forward relaying"]
        pub async fn counterparty_address(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryCounterpartyAddressRequest>,
        ) -> Result<tonic::Response<super::QueryCounterpartyAddressResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " FeeEnabledChannels returns a list of all fee enabled channels"]
        ...
        #[doc = " FeeEnabledChannel returns true if the provided port and channel identifiers belong to a fee enabled channel"]
